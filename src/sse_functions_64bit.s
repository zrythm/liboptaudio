...
#; void mix_buffers_with_gain_sse (float *dst, float *src, unsigned int nframes, float gain);

.globl mix_buffers_with_gain_sse
	.type	mix_buffers_with_gain_sse,@function
...
.size	mix_buffers_with_gain_sse, .-mix_buffers_with_gain_sse
